...
namespace HospitalAPI.DataAccess.Migrations
{
    ...
    [Migration("20220627135029_isAfrernoon added to prescription")]
    partial class isAfrernoonaddedtoprescription
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.MedicineModel.Medicine", b =>
                {
                    ...
                    b.Property<int?>("MedicineManufacturarId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MedicineManufacturarId");

                    b.ToTable("Medicine");
                });

            modelBuilder.Entity("HospitalAPI.Core.Models.MedicineModel.MedicineManufacturar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MedicineManufacturar");
                });

            modelBuilder.Entity("HospitalAPI.Core.Models.MedicineModel.MedicineStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.PatientModel.MonthlyCheckupPregnancy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MonthlyCheckupPregnancy");
                });
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.PatientModel.Pregnancy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.PrescriptionModel.MedicineForPrescription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MedicineForPrescription");
                });
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.PrescriptionModel.Prescription", b =>
                {
                    ...
                    b.Property<bool>("IsTelimedicine")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.TelemedicineModel.Telemedicine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime?>("CallingTime")
                        .HasColumnType("datetime2");

                    b.Property<int?>("PatietnId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.MedicineModel.Medicine", b =>
                {
                    b.HasOne("HospitalAPI.Core.Models.MedicineModel.MedicineManufacturar", "MedicineManufacturar")
                        .WithMany()
                        .HasForeignKey("MedicineManufacturarId");

                    b.Navigation("MedicineManufacturar");
                });
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.MedicineModel.MedicineStock", b =>
                {
                    ...
                    b.HasOne("HospitalAPI.Core.Models.MedicineModel.Medicine", "Medicine")
                        .WithMany()
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.PatientModel.MonthlyCheckupPregnancy", b =>
                {
                    b.HasOne("HospitalAPI.Core.Models.PatientModel.Pregnancy", "Pregnancy")
                        .WithMany("MonthlyCheckupPregnancy")
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.PrescriptionModel.MedicineForPrescription", b =>
                {
                    ...
                    b.HasOne("HospitalAPI.Core.Models.PrescriptionModel.Prescription", "Prescription")
                        .WithMany("MedicineForPrescription")
                        .HasForeignKey("PrescriptionId");
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.TelemedicineModel.Telemedicine", b =>
                {
                    b.HasOne("HospitalAPI.Core.Models.ApplicationUser", "Caller")
                        .WithMany()
                        .HasForeignKey("CallerId");

                    b.HasOne("HospitalAPI.Core.Models.ApplicationUser", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.PatientModel.Pregnancy", b =>
                {
                    b.Navigation("MonthlyCheckupPregnancy");
                });
            ...
            modelBuilder.Entity("HospitalAPI.Core.Models.PrescriptionModel.Prescription", b =>
                {
                    ...
                    b.Navigation("MedicineForPrescription");
                });
